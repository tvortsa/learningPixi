...
Пошаговое введение в создание игр и интерактивных медиа с помощью
[движка рендеринга Pixi](https://github.com/pixijs/pixi.js). **[Обновлено для Pixi v4.5.5](https://github.com/pixijs/pixi.js/releases/tag/v4.5.5)**. [Chinese version here: Pixi官方教程中文版](https://github.com/Zainking/learningPixi). If you like this
...
3. [Создание сцены и renderer](#application)
4. [Pixi спрайты](#sprites)
5. [Loading загрузка изображений в кэш текстур](#loading)
6. [Отображение спрайтов](#displaying)
  1. [Using Aliases](#usingaliases)
  2. [Немного подробностей о загрузке чего-либо](#alittlemoreaboutloadingthings)
    1. [Сделать спрайт из обычного JavaScript Image объекта или Canvas](#makeaspritefromanordinaryjavascriptimageobject)
    2. [Назначение имени загруженному файлу](#assigninganametoaloadingfile)
    3. [Мониторинг прогресса загрузки](#monitoringloadprogress)
    4. [Больше о Pixi загрузчике](#moreaboutpixisloader)
7. [Позиционирование спрайтов](#positioning)
8. [Размер и масштаб](#sizenscale)
9. [Вращение](#rotation)
10. [Создание спрайта из tileset sub-image](#tileset)
11. [Используем атлас текстур](#textureatlas)
12. [Загрузка атласа текстур](#loadingatlas)
13. [Создание спрайта из загруженного атласа текстур](#creating-sprites-from-a-loaded-texture-atlas)
14. [Перемещение спрайтов](#movingsprites)
15. [Используем свойство velocity](#velocity)
16. [Game states](#gamestates)
17. [Перемещение клавишами](#keyboard)
18. [Группировка спрайтов](#grouping)
  1. [Локальное и глобальное позиционирование](#localnglobal)
...
19. [Графические примитивы Pixi](#graphic)
  ...
  2. [Круг](#circles)
  3. [Эллипс](#ellipses)
  4. [Прямоугольник со скругленными углами](#rounded-rectangles)
  5. [Линия](#lines)
  6. [Полигон](#polygons)
20. [Отображаемый текст](#text)
21. [Определение столкновений](#collision)
  1. [Функция hitTestRectangle](#the-hittestrectangle-function)
22. [Практический пример: Treasure Hunter](#casestudy)
  1. [Инициализация игры в функции setup](#initialize)
    1. [Создание игровой сцены](#gamescene)
    2. [Создание подземелья, двери, explorer and treasure](#makingdungon)
    3. [Создание blob monsters](#makingblob)
    4. [Полоска здоровья](#healthbar)
    5. [Текстовые сообщения](#message)
  2. [Играе в игру](#playing)
  3. [Перемещение explorer](#movingexplorer)
    1. [Containing movement](#containingmovement)
  4. [Перемещение монстров](#movingmonsters)
  5. [Проверка столкновений](#checkingcollisions)
  6. [Достижение двери exit и завершение игры](#reachingexit)
23. [Больше о спрайтах](#spriteproperties)
